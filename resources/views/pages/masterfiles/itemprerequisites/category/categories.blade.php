            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                    <a href={{Route('itemCategories.create')}} class="btn btn-primary font-weight-bolder">
...
<script src="/js/pages/masterfiles/itemprerequisites/category/categories.js?v=7.0.4"></script>
<!--end::Page Scripts-->
<!--begin::Page Scripts(used by this page)-->
