            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="/warehouse/create" class="btn btn-primary font-weight-bolder">
...
<script src="/js/pages/masterfiles/itemprerequisites//warehouse/warehouse.js?v=7.0.4"></script>
<!--end::Page Scripts-->
<!--begin::Page Scripts(used by this page)-->
